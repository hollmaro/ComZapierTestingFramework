...
public class WebElementOnPage {
	...
	public boolean typeTextIntoInput(String text, String keyInputLocator){
		try {
			WebElement input = driver.findElement(ConfigData.ui(keyInputLocator));
	...
	public boolean clickLink(String keyLinkLocator) {
		try {
			WebElement link = driver.findElement(ConfigData.ui(keyLinkLocator));
			link.click();
	...
	public boolean clickButton(String keyButtonLocator) {
		try {
			WebElement button = driver.findElement(ConfigData.ui(keyButtonLocator));
			button.click();
	...
	public boolean clickOnRadioButton(String keyRadioButtonLocator){
		try {
			WebElement radioButton = driver.findElement(ConfigData.ui(keyRadioButtonLocator));
			radioButton.click();
	...
	public boolean selectItemFromDDByText(String text, String keyMainDDLocator) {
		try {
			WebElement mainDD = driver.findElement(ConfigData.ui(keyMainDDLocator));
	...
	public boolean setActionInCheckBox(String checkBoxStateFromTC,
		...
		try {
			WebElement checkBox = driver.findElement(ConfigData.ui(keyCheckBoxLocator));
	...
	public boolean isElementOnPage(String keyElementLocator){
		try {
			WebElement element = driver.findElement(ConfigData.ui(keyElementLocator));
	...
	public boolean isElementHasEmptyValue(String keyElementLocator){
		try {
			WebElement tempElement = driver.findElement(ConfigData.ui(keyElementLocator));
